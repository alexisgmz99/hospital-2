         ...
         <li>
            <button type="button" class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
               <span class="material-symbols-outlined">badge</span>
                  <span class="flex-1 ms-3 text-left rtl:text-right whitespace-nowrap">Recursos Humano</span>
...
clinical_notes
            ...
            <ul id="dropdown-example6" class="hidden py-2 space-y-2">
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Registros Medicos</a>
                  </li>
                  <li>
...
pediatrics
            ...
            <ul id="dropdown-example3" class="hidden py-2 space-y-2">
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Nacimiento</a>
                  </li>
                  <li>
...
medication_liquid
            ...
            <ul id="dropdown-example4" class="hidden py-2 space-y-2">
                  ...
                  <li>
                     <a href="#" class="flex items-center w-full p-2 text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Lote de medicamentos</a>
                  </li>
                  <li>
...
pulmonology
         ...
         <li>
            <a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span class="flex-1 ms-3 whitespace-nowrap">Cerar Sesion</span>
            </a>
         </li>
